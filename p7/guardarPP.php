...
<body>
	<h1>Agregar Informacion de catastro</h1>
	<form action="guardaragregar.php" method="GET">

		<input id="id"type="hidden" name="id" value="<?php echo $last_id; ?>">
		<div class="mb-3">
	    	<label class="form-label" for="zona">Zona</label>
	    	<input value="<?php echo $zona; ?>"type="text" name="zona" id="zona" required>
	    </div>	
		<div class="mb-3">
	    ...
	    <div class="mb-3">
	    	...
	    	<input value="<?php echo $distrito; ?>"type="text" name="distrito" id="distrito" required>
	    	</div>
	    <div class="mb-3">
